...
from task_chain.parser.json_fix_general import correct_json
from task_chain.llm_utils import call_ai_function
from task_chain.logs import logger
from task_chain.speech import say_text
...
JSON_SCHEMA = """
{
    ...
    "thoughts":
    {
        "text": "thought",
        "reasoning": "reasoning",
        "decomposer": "- short bulleted\n- list that conveys\n- long-term decomposer",
...
def fix_json_using_multiple_techniques(assistant_reply: str, schema: str=None, **kwargs) -> Dict[Any, Any]:
...
def fix_and_parse_json(
        json_to_load: str, try_to_fix_with_gpt: bool = True, schema: str = None
) -> Dict[Any, Any]:
...
def try_ai_fix(
        try_to_fix_with_gpt: bool, exception: Exception, json_to_load: str, schema: str=None
) -> Dict[Any, Any]:
    ...
    ai_fixed_json = auto_fix_json(json_to_load, schema)
...
def attempt_to_fix_json_by_finding_outermost_brackets(json_string: str, schema: str=None) -> Dict[Any, Any]:
    ...
    return fix_and_parse_json(json_string, schema=schema)