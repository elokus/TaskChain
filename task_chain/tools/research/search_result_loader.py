...
from task_chain.utilities import google_organic_search, load_dotenv_from_parents
from task_chain.schema.base import SearchResultItems
...
class SearchResultLoader(BaseLoader):
    ...
    def _load_pdf(self, url: str) -> list[Document]:
        from task_chain.tools.research.search_pdf_urls import SearchPDFUrls
        from task_chain.tools.research.pdf_loader import load_pdf_documents_from_url
