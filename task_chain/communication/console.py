...
from task_chain.communication.units.interaction.console import ConsoleInteractor
...
class SimpleConsoleCommunicator(BaseCommunicator, AbstractSingleton):
    """A Singleton Facade for all communication systems"""

    def __init__(
            self,
            messaging: BaseMessagingUnit = SimpleMessaging(),
            interactor: BaseMessagingUnit = ConsoleInteractor(),
    ):
